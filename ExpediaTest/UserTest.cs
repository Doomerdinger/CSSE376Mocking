...
namespace ExpediaTest
{
	...
	public class UserTest
	{
        ...
        {
            ServiceLocator serviceLocator = new ServiceLocator();
            var flightToBook = new Flight(DateTime.Now, DateTime.Now.AddDays(10), 1000);
            var unbookedFlight = new Flight(DateTime.Now, DateTime.Now.AddDays(5), 555);
            serviceLocator.AddFlight(flightToBook);
            serviceLocator.AddFlight(unbookedFlight);
            typeof(ServiceLocator).GetField("_instance", BindingFlags.Static | BindingFlags.NonPublic)
                .SetValue(serviceLocator, serviceLocator);
            ...
            Assert.AreSame(unbookedFlight, ServiceLocator.Instance.AvailableFlights[0]);
        }
